  ...
  const promotions = [
    {
      id: 1,
      title: '新會員專屬禮遇',
      subtitle: '首次購買現折 NT$100',
      description: '註冊成為 SAENGAK 會員即可領取 NT$100 首購優惠券，全館結帳皆可折抵',
    ...
    },
    {
      id: 2,
      title: '全館滿額免運',
      subtitle: '單筆訂單滿 NT$1,500 免運費',
      description: '全館單筆訂單滿 NT$1,500 即享免運到府或超商取貨服務',
    ...
    },
    {
      id: 3,
      title: '日常養護組合特惠',
      subtitle: '經典多入組合享專屬折扣',
      description: '選購 SAENGAK 明星洗護組合商品，立即享受多重專屬折扣與貼心配件贈品',
    ...
    },
    {
      ...
      title: 'VIP 會員生日禮',
      subtitle: '生日月份專屬購物金',
      description: '認證會員於生日當月可獲得專屬購物金，陪伴妳度過最特別的日子',
    ...
    },
    {
      ...
      title: '好友美好分享',
      subtitle: '邀請好友同享購物金',
      description: '成功推薦好友完成首次下單，雙方皆可獲得購物金折抵券',
    ...
    },
    {
      ...
      title: '季末回饋限定',
      subtitle: '限定商品優惠中',
      description: '精選換季舒緩養護商品，為私密肌膚帶來最純淨舒適的呵護體驗',
