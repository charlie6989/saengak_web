            ...
            {currentStep === 1 && (
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                  目前網站提供女性日常護理商品目錄；成分、認證、測試與使用方式，須以正式商品欄位及包裝標示為準。
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                  ...
                  <div className="text-center p-4">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-2">成分資訊</h3>
                    <p className="text-sm text-gray-600">以商品包裝與正式欄位為準</p>
                  </div>
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-gray-600">客服管道確認中</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6 text-center border border-purple-100">
                    ...
                    <h3 className="font-bold text-gray-900 mb-2 text-lg">配送費用</h3>
                    <p className="text-purple-600 font-semibold text-xl mb-2">以結帳頁為準</p>
                    <p className="text-sm text-gray-600">依地址、配送方式與商品條件計算</p>
                  </div>
                </div>
